  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 w-full">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto mb-12 bg-gray-50 border rounded-2xl p-6 text-center shadow-sm">
          ...
          <p className="text-gray-700 mb-5">
            ...
            availability. Need BLS now? You can also pay online and secure your spot.
          </p>
      ...
      <section id="pay" className="py-16 px-6 bg-red-600 text-white w-full">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg max-w-2xl mx-auto">
            Ready to move forward? Pay online for BLS certification or visit the
            pricing page to view all available payment and booking options.
          </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="bg-white text-gray-900 rounded-2xl p-8 shadow-lg">
              ...
              <p className="mt-3 text-gray-700">
                Secure your BLS class online and reserve your spot quickly and easily.
              </p>
            ...
            <div className="bg-white text-gray-900 rounded-2xl p-8 shadow-lg">
              <h3 className="text-xl font-semibold">Other Courses & Group Training</h3>
              <p className="mt-3 text-gray-700">
                Need another course or group booking? Visit the pricing page for
                payment options or submit a request for custom training.
              </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border bg-gray-50 p-6 shadow-sm">
              ...
              <p className="mt-2 text-gray-700">
                Click <span className="font-semibold">Book a Class</span> to complete
                the Training Request Form, or visit the pricing page to pay directly
            ...
            <div className="rounded-2xl border bg-gray-50 p-6 shadow-sm">
              ...
              <p className="mt-2 text-gray-700">
                Yes. Online payment is now available for select courses. Visit the
                pricing page to view payment options, or submit a request for group
                and custom training.
              </p>
            </div>
            ...
            <div className="rounded-2xl border bg-gray-50 p-6 shadow-sm md:col-span-2">
              ...
              <p className="mt-2 text-gray-700">
                Yes. This course is available for individuals and workplaces and is
                priced at <span className="font-semibold">$35</span>.
              </p>
            </div>
          </div>
      ...
      <section id="contact" className="py-16 px-6 text-center w-full">
        ...
        <p className="mb-6">
          Call, email, pay online, or submit a training request today.
        </p>
