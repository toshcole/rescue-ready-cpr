...
export default function RescueReadyWebsite() {
  ...
  />
      ...
      {/* SERVICES */}
      <section className="py-16 px-6 max-w-6xl mx-auto">{/* READY TO SCHEDULE */}
<section className="py-12 px-6 bg-white">
  <div className="max-w-4xl mx-auto text-center">
    <h2 className="text-2xl font-semibold mb-3">Ready to schedule?</h2>
    <p className="mb-6">
      Submit a training request and we’ll respond within 24 hours to confirm availability and pricing.
    </p>
    <a href="https://forms.gle/4uaGwidx2i6nYnZb9" target="_blank" rel="noreferrer">
